    ...
    return (
        <div className="set-apart-wrap">
            <div className="sa-top" ref={setApartT}>
                <div className="sa-headline">CHOOSE GP OUTDOOR SOLUTIONS</div>
                <h2>Choosing GP Outdoor Solutions Means Choosing Reliability, Hard Work, & Results You Can See. <b>Here's What Sets Us Apart:</b></h2>
            ...
            <div className="sa-base" ref={setApartB}>
                ...
                <img src={Images.heroImg1} className="sa-img" />
                <img src={Images.heroImg1} className="sa-img-height" />
            </div>
        </div>
    )
}
